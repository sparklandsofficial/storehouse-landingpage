...
export default function Home() {
  const t = useTranslations("HomeBranchPage");
        ...
        <section className="py-16">
          <div className="flex flex-col space-y-4 md:flex-row md:items-center md:justify-between md:space-y-0 mb-8">
            <div className="flex flex-col space-y-4 md:flex-row md:items-center md:space-x-4 md:space-y-0">
              <div className="text-xl font-bold">{t("filterTitle")}</div>
              <div className="flex flex-col space-y-4 md:flex-row md:space-x-4 md:space-y-0">
                <Select defaultValue={city} onValueChange={setCity}>
                  ...
                  <SelectContent>
                    <SelectItem value="台北市">{t("cityTaipei")}</SelectItem>
                ...
                <Select defaultValue={district} onValueChange={setDistrict}>
                  ...
                  <SelectContent>
                    <SelectItem value="松山區">{t("distSongshan")}</SelectItem>
          ...
          <Link href="/branches/1">
            <h3 className="text-2xl md:text-2xl font-bold mb-4">{t("storeTitle")}</h3>
            <hr />
