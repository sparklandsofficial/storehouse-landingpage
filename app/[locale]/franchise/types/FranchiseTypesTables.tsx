/** 加盟型態內文表格（數字與條款仍以中文為主，供法務／在地閱讀） */
export default function FranchiseTypesTables() {
  return (
    <>
        ...
        <table className="w-full border-collapse bg-white shadow-lg rounded-lg">
          <thead>
            <tr className="bg-[#F5F5F5]">
              ...
              <th className="border p-4 w-[37.5%] text-xl font-bold">一般加盟A</th>
              <th className="border p-4 w-[37.5%] text-xl font-bold">一般加盟B</th>
            </tr>
          </thead>
          ...
          <tbody>
            ...
            <tr>
              <td className="border p-4 font-bold bg-[#F5F5F5]">年度系統維運費</td>
            ...
            <tr>
              ...
              <td className="border p-4" colSpan={2}>
                <ul className="list-disc pl-5 space-y-2">
                  <li>以上費用皆為未稅金額。</li>
                  <li>各加盟主須以不動產持有人進行加盟，但營運需要設立公司。</li>
                  <li>租金收入由星域智空間代收，於次月20日前匯入加盟主公司帳戶，押金部分保留於星域智空間代管。</li>
      ...
      <div className="overflow-x-auto">
        <table className="w-full border-collapse bg-white shadow-lg rounded-lg">
          <thead>
            <tr className="bg-[#F5F5F5]">
              <th className="border p-4 w-1/4"></th>
              <th className="border p-4 w-[37.5%] text-xl font-bold">特許加盟A</th>
              <th className="border p-4 w-[37.5%] text-xl font-bold">特許加盟B</th>
            </tr>
          </thead>
