/** 隱私權政策正文（繁中）— 與原 `privacy/page` 內文一致，供 Tailwind 編譯 */
export default function PrivacyDocZhTW() {
  return (
    <div className="bg-surface-container-lowest cloud-shadow rounded-2xl p-8 md:p-10 border border-outline-variant/5 prose">
      <div className="not-prose bg-primary/6 rounded-xl p-5 border-l-4 border-primary mb-8">
        <p className="text-sm text-on-surface-variant leading-relaxed">
          ...
          當您使用「Spark Space 星域智空間」APP 或相關服務時，即表示您同意本隱私權政策之全部內容。
        </p>
      </div>
      ...
      <ul>
        <li>
          <strong>提供和改進服務：</strong>處理租倉申請、合約管理、進出管理及退租等事項
        </li>
        <li>
          <strong>處理交易和付款：</strong>開立電子發票、處理信用卡扣款、退款作業
        </li>
        <li>
          <strong>身份驗證與安全管理：</strong>確認租戶身份、管控門禁進出權限
        </li>
        <li>
          <strong>與您溝通：</strong>發送繳費提醒、服務通知及客服往來
        </li>
        <li>
          <strong>分析與改善：</strong>分析匿名化使用數據，優化 APP 功能與服務品質
        </li>
        <li>
      ...
      <ul>
        <li>
          <strong>傳輸加密：</strong>APP 與伺服器間之資料傳輸採用 TLS 加密協定
        </li>
        <li>
          <strong>儲存安全：</strong>敏感個人資料在資料庫中以加密方式儲存
        </li>
        <li>
          <strong>存取控制：</strong>僅授權人員可存取個人資料，設有多重身份驗證機制
        </li>
        <li>
          <strong>最小化原則：</strong>僅蒐集履行服務所必要之最少個人資料
        </li>
        <li>
          <strong>事故應變：</strong>若發生個人資料外洩，本公司將依《個人資料保護法》規定通知受影響之當事人並採取補救措施
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          <strong>雲端服務供應商：</strong>提供 APP 系統及資料儲存服務（均受保密協議約束）
        </li>
        <li>
      ...
      <h3>門禁進出紀錄</h3>
      <p>
        每次進出均記錄時間戳記及密碼使用類型，用於安全管理及爭議解決。保存期間為 <strong>180 天</strong>
        ，期滿自動刪除。
      </p>
      <h3>監控影像</h3>
      <ul>
      ...
      <div className="not-prose overflow-x-auto my-4">
        <table className="w-full text-sm border-collapse">
          ...
          <tbody className="divide-y divide-outline-variant/10">
            <tr>
              <td className="px-4 py-3 text-on-surface-variant border border-outline-variant/10">租倉合約與交易紀錄</td>
            ...
            <tr>
              <td className="px-4 py-3 text-on-surface-variant border border-outline-variant/10">發票與財務紀錄</td>
            ...
            <tr>
              <td className="px-4 py-3 text-on-surface-variant border border-outline-variant/10">門禁進出紀錄</td>
            ...
            <tr>
              <td className="px-4 py-3 text-on-surface-variant border border-outline-variant/10">APP 帳號資料</td>
              <td className="px-4 py-3 text-on-surface-variant border border-outline-variant/10">帳號刪除後 30 天</td>
      ...
      <ul>
        <li>
          <strong>查詢或閱覽：</strong>確認本公司是否持有您的資料並請求閱覽
        </li>
        <li>
          <strong>補充或更正：</strong>若資料不正確，請求補充或更正
        </li>
        <li>
          <strong>停止蒐集或利用：</strong>符合法定事由時，請求停止處理您的資料
        </li>
        <li>
          <strong>刪除：</strong>符合法定事由時，請求刪除（依法須保存者除外）
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          <strong>分析性 Cookie：</strong>了解網站使用狀況，可透過瀏覽器設定關閉
        </li>
      </ul>

      <h2 id="s9">9. 未成年人保護</h2>
      <p>
        本公司服務限 18 歲（含）以上成年人使用，不會在明知的情況下蒐集未成年人個人資料。若發現未成年人已提供資料，請立即聯繫我們，本公司將儘速刪除。
      </p>

      <h2 id="s10">10. 政策更新</h2>
      <p>
        我們可能不時更新本隱私權政策。任何重大變更將透過 APP 通知及本頁面公佈，修訂後政策於公告後 <strong>7 日</strong>
