...
/** 服務條款正文（繁中） */
export default function TermsDocZhTW() {
  const prohibited = [
    ...
    <div className="bg-surface-container-lowest cloud-shadow rounded-2xl p-8 md:p-10 border border-outline-variant/5 prose">
      <div className="not-prose bg-primary/6 rounded-xl p-5 border-l-4 border-primary mb-8">
        <p className="text-sm text-on-surface-variant leading-relaxed">
          ...
          當您下載並使用「Spark Space 星域智空間」APP 或租用本公司倉位時，即表示您已閱讀、理解並同意本服務條款之全部內容。若您不同意本條款，請勿使用本服務。
        </p>
      </div>
      ...
      <ul>
        ...
        <li>
          如欲續約，請於到期日 <strong>14 日前</strong>透過 APP 辦理，並完成付款。
        </li>
      ...
      <ul>
        <li>
          押金於退租並確認倉位已清空、無損壞且結清所有費用後，於 <strong>7 日內</strong>退還（信用卡刷退方式）。
        </li>
      </ul>
      <h3>計費方案</h3>
        ...
        <table className="w-full text-sm border-collapse">
          ...
          <tbody className="divide-y divide-outline-variant/10">
            <tr>
              ...
              <td className="px-4 py-3 text-on-surface-variant border border-outline-variant/10">最彈性，可隨時退租</td>
            </tr>
            <tr>
              <td className="px-4 py-3 text-on-surface-variant border border-outline-variant/10">季租（3 個月）</td>
              <td className="px-4 py-3 text-on-surface-variant border border-outline-variant/10">95 折（5% OFF）</td>
              <td className="px-4 py-3 text-on-surface-variant border border-outline-variant/10">一次付清 3 個月</td>
            </tr>
            <tr>
              <td className="px-4 py-3 text-on-surface-variant border border-outline-variant/10">年租（12 個月）</td>
              <td className="px-4 py-3 text-on-surface-variant border border-outline-variant/10">八折（20% OFF）</td>
              <td className="px-4 py-3 text-on-surface-variant border border-outline-variant/10">一次付清 12 個月，省最多</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <ul>
        <li>
          逾期 <strong>5 日</strong>未繳納租金者，自第 6 天起每日加收原租金 <strong>1%</strong> 之滯納金。
        </li>
        <li>
          逾期達 <strong>1 個月</strong>仍未繳清者，本公司有權立即終止合約，並視同您拋棄倉內置放物之所有權。
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          扣除 <strong>一個月押金</strong>作為違約金後退還餘額。
        </li>
      </ul>
      <h3>季繳 / 年繳優惠方案</h3>
      <ul>
        <li>
          提前退租時，按未使用月數退還<strong>原價</strong>租金（非優惠價）。
        </li>
        <li>
          扣除 <strong>一個月押金</strong>作為違約金後退還餘額。
        </li>
      ...
      <p>
        上層倉位之物品總重量不得超過 <strong>200 公斤</strong>。
      </p>
      ...
      <ul>
        ...
        <li>
          積欠租金且滯納金已高於押金，本公司得經 <strong>10 日</strong>催告後，立即終止合約。
        </li>
      </ul>
      ...
      <p>
        本公司保留隨時修改本服務條款之權利。修訂後條款於公告後 <strong>7 日</strong>起生效。繼續使用本服務即表示您接受修改後的條款。
      </p>

      <h2 id="t14">14. 準據法與管轄法院</h2>
      <p>
        本服務條款以<strong>中華民國法律</strong>為準據法。因本條款或使用本服務所生之爭議，雙方同意以<strong>台灣台北地方法院</strong>為第一審管轄法院。
      </p>
